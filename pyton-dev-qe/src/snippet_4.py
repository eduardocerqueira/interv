...
:topic Pyhton 
:level intermediate 
:disclousure this file was copied from upstream Robottelo project that shows 
            Python codes driving Selenium UI tests running with Robottelo 
            Framework. The project source code can be cloned/downloaded from:
            https://github.com/SatelliteQE/robottelo/ and this file is
            https://github.com/SatelliteQE/robottelo/blob/master/tests/foreman/rhai/test_rhai.py
